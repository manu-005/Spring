...
<section id="about">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            ...
            <p class="mt-3" style="color:var(--text-light); font-size:16px; max-width:520px; margin:14px auto 0;">
                Empowering conference hosts and delegates with world-class tools.</p>
        </div>
        <div class="row g-4">
...
<footer>
    <div class="container">
        <div class="row g-4">
            <div class="col-md-4">
                <h4>ConferoNexus</h4>
                <p>Global Conference &amp; Event Management Platform. Connecting Speakers, Organizers and Attendees
                    Worldwide.</p>
