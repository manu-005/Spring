    ...
    <div class="card shadow-lg border-0">
        <div class="card-body p-4">
            ...
            <div class="row">
                ...
                <!-- LEFT SIDE : TARGET DELEGATES -->
                <div class="col-md-4 border-end pe-4">

                    <h4 class="mb-4 text-center">Target Delegates</h4>

                    <form action="filterDelegates" method="get" class="mb-2">
                        <input type="hidden" name="type" value="Students">
                        <button class="btn btn-outline-primary w-100">Students</button>
                    </form>

                    <form action="filterDelegates" method="get" class="mb-2">
                        <input type="hidden" name="type" value="Developers">
                        <button class="btn btn-outline-primary w-100">Developers</button>
                    </form>

                    <form action="filterDelegates" method="get" class="mb-2">
                        <input type="hidden" name="type" value="Researchers">
                        <button class="btn btn-outline-primary w-100">Researchers</button>
                    </form>

                    <form action="filterDelegates" method="get" class="mb-2">
                        <input type="hidden" name="type" value="Entrepreneurs">
                        <button class="btn btn-outline-primary w-100">Entrepreneurs</button>
                    </form>

                    <form action="filterDelegates" method="get" class="mb-2">
                        <input type="hidden" name="type" value="Industry Professionals">
                        <button class="btn btn-outline-primary w-100">Industry Professionals</button>
                    </form>

                </div>


                <!-- RIGHT SIDE : DELEGATES TABLE -->
                <div class="col-md-8 ps-4">

                    <h4 class="mb-4 text-center">Delegates List</h4>
